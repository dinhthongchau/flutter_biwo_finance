...
class _CategoryListScreenState extends State<CategoryListScreen> {
  ...
  String _getCategoryIconPath(String categoryType, MoneyType moneyType) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: Container(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: Text(
              widget.moneyType == MoneyType.expense
                  ? 'Add Transaction Expense'
                  : widget.moneyType == MoneyType.income
      ...
      appBar: AppBar(
        ...
        title: Text(
          _getScreenTitle(widget.moneyType),
