...
class NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<NotificationBloc, NotificationState>(
      builder: (context, state) {
        final notificationData = _groupNotificationsBySection(
          state.notifications ?? [],
        );
        ...
        return Scaffold(
          ...
          body: _buildBody(notificationData, state),
        );
      },
    );
  }

  Widget _buildBody(List<Map<String, dynamic>> notificationData, NotificationState state) {
    return Container(
  ...
  List<Map<String, dynamic>> _groupNotificationsBySection(
